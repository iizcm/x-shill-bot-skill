...
[![Category: Social Media](https://img.shields.io/badge/Category-Social%20Media-purple)](#)

| Field | Value |
| --- | --- |
| **Name** | `x-shill-bot-skill` |
...
cp -r social-media/x-shill-bot ~/.hermes/skills/social-media/x-shill-bot/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/x-shill-bot-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/x-shill-bot-skill.git ~/.hermes/skills/social-media/x-shill-bot/
```
...
```text
skill_view(name="social-media/x-shill-bot")
```
...
```text
Use the x shill bot skill to <describe your specific task here>
```
...
```text
Gunakan skill x shill bot untuk <deskripsikan tugas spesifik Anda di sini>
```
